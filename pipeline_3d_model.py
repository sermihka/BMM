...
def cycle(N, vertical = vertical, horizontal_ax1 = horizontal_ax1, horizontal_ax2 = horizontal_ax2):
    ...
    for n in range(N):
        ...
        for ax0 in range(4 + n//50):
            for ax1 in range((ax1_max//2 - (4 + n//50)), (4 + n//50 + ax1_max//2)):
                for ax2 in range((ax2_max//2 - (4 + n//50)), (4 + n//50 + ax2_max//2)):
    ...
    return vertical, horizontal_ax1, horizontal_ax2
